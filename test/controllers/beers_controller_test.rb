...
class BeersControllerTest < ActionController::TestCase
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post :create, beer: { abv: @beer.abv, beer_advocate_average: @beer.beer_advocate_average, brewery_id: @beer.brewery_id, ibu: @beer.ibu, name: @beer.name, style: @beer.style }
    end
  ...
  test "should update beer" do
    patch :update, id: @beer, beer: { abv: @beer.abv, beer_advocate_average: @beer.beer_advocate_average, brewery_id: @beer.brewery_id, ibu: @beer.ibu, name: @beer.name, style: @beer.style }
    assert_redirected_to beer_path(assigns(:beer))
  end
